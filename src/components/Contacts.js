                ...
                <div className="contacts__list">
                    ...
                    <div className="contacts__item">
                        <div className="contacts__img-wrap">
                            <svg xmlns="http://www.w3.org/2000/svg" width={31} height={44} viewBox="0 0 31 44" className="contacts__img">
                    ...
                    <div className="contacts__item">
                        <div className="contacts__img-wrap">
                        <svg xmlns="http://www.w3.org/2000/svg" width="37" height="33.968" viewBox="0 0 37 33.968" className="contacts__img">
                        ...
                        <p className="contacts__text">
                            Main Email : <a href="mailto:contact@website.com">contact@website.com</a><br/>
                            Inquiries : <a href="mailto:Info@mail.com">Info@mail.com</a>
                        </p>
                    </div>
                    <div className="contacts__item">
                        <div className="contacts__img-wrap">
                        <svg xmlns="http://www.w3.org/2000/svg" width={37} height={44} viewBox="0 0 37 44" className="contacts__img">
                        ...
                        <p className="contacts__text">
                            Office Telephone : <a href="tel:0029129102320">0029129102320</a><br/>
                            Mobile : <a href="tel:000232439493">000 2324 39493</a>
                        </p>
                    </div>
